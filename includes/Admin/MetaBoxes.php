...
class MetaBoxes {
    ...
    public function render_type_selector( $post ) {
        ...
        <div class="wprh-type-selector">
            <p class="description"><?php esc_html_e( 'Select the type of resource you are creating.', 'wp-resource-hub' ); ?></p>
            <div class="wprh-type-buttons">
                <?php foreach ( $types as $key => $type ) : ?>
                    <label class="wprh-type-button <?php echo $current_type === $type['slug'] ? 'selected' : ''; ?>">
                        <input type="radio"
                               name="wprh_resource_type"
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <select name="wprh_video_provider" id="wprh_video_provider" class="regular-text">
                            ...
                            <option value="youtube" <?php selected( $video_provider, 'youtube' ); ?>><?php esc_html_e( 'YouTube', 'wp-resource-hub' ); ?></option>
                            <option value="vimeo" <?php selected( $video_provider, 'vimeo' ); ?>><?php esc_html_e( 'Vimeo', 'wp-resource-hub' ); ?></option>
                            <option value="local" <?php selected( $video_provider, 'local' ); ?>><?php esc_html_e( 'Local/Self-hosted', 'wp-resource-hub' ); ?></option>
                        </select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'Optional. The video ID will be auto-extracted from the URL if left empty.', 'wp-resource-hub' ); ?></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        <input type="text"
                               name="wprh_video_duration"
                               id="wprh_video_duration"
                               value="<?php echo esc_attr( $video_duration ); ?>"
                               class="small-text"
                               placeholder="10:30">
                        <p class="description"><?php esc_html_e( 'Optional. Video duration in MM:SS or HH:MM:SS format.', 'wp-resource-hub' ); ?></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        <div class="wprh-media-upload">
                            <input type="hidden"
                                   name="wprh_video_thumbnail"
                                   id="wprh_video_thumbnail"
                            ...
                            <button type="button" class="button wprh-remove-button" data-target="wprh_video_thumbnail" style="<?php echo $video_thumbnail ? '' : 'display:none;'; ?>">
                        ...
                        <p class="description"><?php esc_html_e( 'Optional. Override the default video thumbnail.', 'wp-resource-hub' ); ?></p>
                    </td>
                </tr>
            </table>
        </div>
    ...
    private function render_pdf_fields( $post, $current_type ) {
        ...
        <div class="wprh-type-fields wprh-pdf-fields" data-type="pdf" style="<?php echo esc_attr( $display ); ?>">
            ...
            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="wprh_pdf_file"><?php esc_html_e( 'PDF File', 'wp-resource-hub' ); ?> <span class="required">*</span></label>
                    </th>
                    <td>
                        <div class="wprh-media-upload">
                            <input type="hidden"
                                   name="wprh_pdf_file"
                                   id="wprh_pdf_file"
                                   value="<?php echo esc_attr( $pdf_file ); ?>"
                                   data-required="true">
                            <button type="button" class="button wprh-upload-button" data-target="wprh_pdf_file" data-type="application/pdf">
                                <?php esc_html_e( 'Select PDF', 'wp-resource-hub' ); ?>
                            </button>
                            <button type="button" class="button wprh-remove-button" data-target="wprh_pdf_file" style="<?php echo $pdf_file ? '' : 'display:none;'; ?>">
                                <?php esc_html_e( 'Remove', 'wp-resource-hub' ); ?>
                            </button>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text"
                               name="wprh_pdf_file_size"
                               id="wprh_pdf_file_size"
                               value="<?php echo esc_attr( $pdf_file_size ); ?>"
                               class="small-text"
                               placeholder="2.5 MB">
                        <p class="description"><?php esc_html_e( 'Optional. Will be auto-calculated if left empty.', 'wp-resource-hub' ); ?></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        <input type="number"
                               name="wprh_pdf_page_count"
                               id="wprh_pdf_page_count"
                               value="<?php echo esc_attr( $pdf_page_count ); ?>"
                               class="small-text"
                               min="1">
                        <p class="description"><?php esc_html_e( 'Optional. Number of pages in the PDF.', 'wp-resource-hub' ); ?></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        <select name="wprh_pdf_viewer_mode" id="wprh_pdf_viewer_mode" class="regular-text">
                            <option value="embedded" <?php selected( $pdf_viewer_mode, 'embedded' ); ?>><?php esc_html_e( 'Embedded Viewer', 'wp-resource-hub' ); ?></option>
                            <option value="download" <?php selected( $pdf_viewer_mode, 'download' ); ?>><?php esc_html_e( 'Direct Download', 'wp-resource-hub' ); ?></option>
                        </select>
                    </td>
                </tr>
            </table>
    ...
    private function render_download_fields( $post, $current_type ) {
        ...
        <div class="wprh-type-fields wprh-download-fields" data-type="download" style="<?php echo esc_attr( $display ); ?>">
            ...
            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="wprh_download_file"><?php esc_html_e( 'Download File', 'wp-resource-hub' ); ?> <span class="required">*</span></label>
                    </th>
                    <td>
                        <div class="wprh-media-upload">
                            <input type="hidden"
                                   name="wprh_download_file"
                                   id="wprh_download_file"
                                   value="<?php echo esc_attr( $download_file ); ?>"
                                   data-required="true">
                            ...
                            <button type="button" class="button wprh-remove-button" data-target="wprh_download_file" style="<?php echo $download_file ? '' : 'display:none;'; ?>">
                                <?php esc_html_e( 'Remove', 'wp-resource-hub' ); ?>
                            </button>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text"
                               name="wprh_download_file_size"
                               id="wprh_download_file_size"
                               value="<?php echo esc_attr( $download_file_size ); ?>"
                               class="small-text"
                               placeholder="15 MB">
                        <p class="description"><?php esc_html_e( 'Optional. Will be auto-calculated if left empty.', 'wp-resource-hub' ); ?></p>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text"
                               name="wprh_download_version"
                               id="wprh_download_version"
                               value="<?php echo esc_attr( $download_version ); ?>"
                               class="small-text"
                               placeholder="1.0.0">
                        <p class="description"><?php esc_html_e( 'Optional. Version number for this download.', 'wp-resource-hub' ); ?></p>
                    </td>
                </tr>
            </table>
        </div>
    ...
    private function render_external_link_fields( $post, $current_type ) {
        ...
        ?>
        <div class="wprh-type-fields wprh-external-link-fields" data-type="external-link" style="<?php echo esc_attr( $display ); ?>">
            <h4><?php esc_html_e( 'External Link Settings', 'wp-resource-hub' ); ?></h4>

            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="wprh_external_url"><?php esc_html_e( 'External URL', 'wp-resource-hub' ); ?> <span class="required">*</span></label>
                    </th>
                    <td>
                        <input type="url"
                               name="wprh_external_url"
                               id="wprh_external_url"
                               value="<?php echo esc_url( $external_url ); ?>"
                               class="large-text"
                               placeholder="https://example.com/resource"
                               data-required="true">
                        <p class="description"><?php esc_html_e( 'Enter the full URL of the external resource.', 'wp-resource-hub' ); ?></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        <label>
                            <input type="checkbox"
                                   name="wprh_open_new_tab"
                                   id="wprh_open_new_tab"
                                   value="1"
    ...
    private function render_internal_content_fields( $post, $current_type ) {
        ...
        ?>
        <div class="wprh-type-fields wprh-internal-content-fields" data-type="internal-content" style="<?php echo esc_attr( $display ); ?>">
            <h4><?php esc_html_e( 'Internal Content Settings', 'wp-resource-hub' ); ?></h4>
            <p class="description"><?php esc_html_e( 'The main content will be displayed using the standard WordPress editor above.', 'wp-resource-hub' ); ?></p>
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <textarea name="wprh_summary"
                                  id="wprh_summary"
                                  rows="3"
                                  class="large-text"
                                  placeholder="<?php esc_attr_e( 'Brief summary of this resource...', 'wp-resource-hub' ); ?>"><?php echo esc_textarea( $summary ); ?></textarea>
                        <p class="description"><?php esc_html_e( 'Optional. A short excerpt override for listings and previews.', 'wp-resource-hub' ); ?></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        <input type="number"
                               name="wprh_reading_time"
                               id="wprh_reading_time"
                               value="<?php echo esc_attr( $reading_time ); ?>"
                               class="small-text"
                               min="1"
                               placeholder="5">
                        <span><?php esc_html_e( 'minutes', 'wp-resource-hub' ); ?></span>
                        <p class="description"><?php esc_html_e( 'Optional. Manual reading time override. Will be auto-calculated if left empty.', 'wp-resource-hub' ); ?></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        <fieldset>
                            ...
                            <label>
                                <input type="checkbox"
                                       name="wprh_show_related"
                                       id="wprh_show_related"
                                       value="1"
    ...
    private function save_video_meta( $post_id ) {
        ...
        // Auto-extract video ID if URL provided but no ID.
