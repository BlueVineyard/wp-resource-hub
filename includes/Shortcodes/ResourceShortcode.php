...
?>
        <div
            class="wprh-resource-single wprh-type-<?php echo esc_attr($type_slug); ?> <?php echo esc_attr($atts['class']); ?>">
            ...
            <?php if ($atts['show_image']) : ?>
                <?php
                $thumbnail = Helpers::get_resource_thumbnail($resource, 'large');
                if (! empty($thumbnail)) : ?>
    ...
    ?>
        <article
            class="wprh-resource-card wprh-type-<?php echo esc_attr($type_slug); ?> <?php echo esc_attr($atts['class']); ?>">
            <?php if ($atts['show_image']) : ?>
    ...
    ?>
        <div
            class="wprh-resource-embed wprh-type-<?php echo esc_attr($resource_type); ?> <?php echo esc_attr($atts['class']); ?>">
            <?php if ($atts['show_title']) : ?>
